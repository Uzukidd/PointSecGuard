...
def main(args):
    ...
    if True:
            ...
            for _ in tqdm(range(args.num_votes), total=args.num_votes):
                ...
                for sbatch in range(s_batch_num):
                    ...
                    attack = torchattacks.NU_attack(
                        classifier, c=0.1, kappa=0, steps=1000, lr=0.01
                    )
        ...
        adv_IoU = np.array(adv_total_correct_class) / (
            np.array(adv_total_iou_deno_class, dtype=float) + 1e-6
        )
