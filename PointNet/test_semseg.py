...
def parse_args():
    ...
    parser.add_argument(
        "--batch_size", type=int, default=16, help="batch size in testing [default: 32]"
    )
    ...
    parser.add_argument(
        "--log_dir", type=str, default="pointnet2_sem_seg", help="Experiment root"
    )
    parser.add_argument(
        "--visual",
        action="store_true",
...
def main(args):
    ...
    # root = '../../datasets/stanford_indoor3d/'
        ...
        for batch_idx in range(num_batches):
            ...
            for i in range(whole_scene_label.shape[0]):
                ...
                if args.visual:
                    ...
                    # fout_adv_raw.write('%f %f %f %f %f %f\n' % (whole_scene_data[i, 0], whole_scene_data[i, 1], whole_scene_data[i, 2], whole_scene_data[i, 3], whole_scene_data[i, 4], whole_scene_data[i, 5]))
